...
var dayColor="#ffffff";
var currentDayColor="#ffee1c";
var footColor="#ff0000";
...
if (isN4) {
  ...
  document.writeln("<layer id='"+cal+"' z-index='10001'>&nbsp;</layer>");
}
else {
  //document.writeln("<div id='"+cal+"' style='position:absolute; z-index:2;'>&nbsp;</div>");
  document.writeln("<div id='"+cal+"' style='position:absolute; z-index:10001;'>&nbsp;</div>");
}
// ----
