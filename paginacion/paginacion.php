...
<table bgcolor="#FFFFFF" width="100%">
  ...
  <tbody>
    ...
    <tr>
	  ...
	  ?>
	  <td> <input type="button" name="cmdComando" value="<<" onclick="javascript:irAPagina('1',document.frmPaginacion.txtRegistrosPagina.value);" <? echo $styleAtras; ?>  style="background:#f7ff1c"> </td>
      <td> <input type="button" name="cmdComando" value="<" onclick="javascript:irAPagina('<? echo ($paginaActual -1);  ?>',document.frmPaginacion.txtRegistrosPagina.value);"  <? echo $styleAtras; ?>  style="background:#f7ff1c"> </td>
      <td> <input type="button" name="cmdComando" value=">" onclick="javascript:irAPagina('<? echo ($paginaActual +1);  ?>',document.frmPaginacion.txtRegistrosPagina.value);"  <? echo $styleAdelante; ?>  style="background:#f7ff1c"> </td>
      <td> <input type="button" name="cmdComando" value=">>" onclick="javascript:irAPagina('<? echo $cantidadPaginas;  ?>',document.frmPaginacion.txtRegistrosPagina.value);"  <? echo $styleAdelante; ?>  style="background:#f7ff1c"> </td>
      <td> 
	  	Registros/P&aacute;gina:
			...
			<input type="button" name="cmdRegistrosPagina" value="Aceptar" onclick="javascript:irAPagina('<? echo $paginaActual; ?>',document.frmPaginacion.txtRegistrosPagina.value);" style="background:#f7ff1c">
	  </td>
